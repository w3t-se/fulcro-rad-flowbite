...
(defn- with-handlers [type {:keys [value onChange onBlur] :as props}]
  (assoc props
    :class "bg-white border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-zinc-800 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
    :value (or value "")
    :type type
    :onBlur (fn [evt]
              (when onBlur
